      ...
      <Comp
        ...
        className={cn(
          "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary disabled:pointer-events-none disabled:opacity-50",
          {
            ...
            "border border-white/20 bg-transparent shadow-sm hover:bg-white/10 dark:hover:bg-white/5": variant === "outline",
            "hover:bg-white/10 dark:hover:bg-white/5": variant === "ghost",
            "glass hover:bg-white/20 text-foreground border-white/10 shadow-lg": variant === "glass",
